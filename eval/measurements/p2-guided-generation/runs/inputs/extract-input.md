List the 4-6 structural commitments any faithful definition of this concept must preserve, as short testable items. Use only ordinary plain-English words plus simple notation. Do NOT use any names of people, fields, disciplines, methods, or acronyms. Do NOT reuse any specialized term the notes use as the project's own label for the concept. Return only the numbered list.
