...
7. ⟦TERM⟧ results were actually the bright spot — halved budget mid-task on all four fielded agents, three switched to terser output before running out, only one blew through the limit without adjusting.