...
7. Across six releases, the suite tracked ⟦TERM⟧ alongside completion and calibration metrics. The ⟦TERM⟧ doubled for basic tasks, prompting targeted replacement rather than wholesale removal.
8. Across six releases, the suite tracked ⟦TERM⟧ alongside completion and calibration metrics. The ⟦TERM⟧ doubled for basic tasks, prompting targeted replacement rather than wholesale removal.