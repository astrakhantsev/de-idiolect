...
## excerpt
source: <vault>/10_projects/minelit/flf/2026-07-12-flf-claims-explained.md (approx location: "First: the one idea everything hangs off", lines ~28-39)
...
## excerpt
source: <vault>/10_projects/minelit/flf/2026-07-12-flf-claims-explained.md (approx location: "First: the one idea everything hangs off", lines ~43-49)
...
## excerpt
source: <vault>/10_projects/minelit/flf/2026-07-12-flf-claims-explained.md (approx location: Claim 3, line ~118)
...
## excerpt
source: <vault>/10_projects/minelit/flf/2026-07-12-flf-claims-explained.md (approx location: Claim 11 "m* is a ratio", lines ~253-259)
...
## excerpt
source: <vault>/10_projects/minelit/flf/2026-07-12-flf-claims-explained.md (approx location: Claim 4, line ~128)
...
## excerpt
source: <vault>/10_projects/minelit/flf/2026-07-11-flf-operating-requirement-and-estimand-scope-session.md (approx location: §3 "FINDING B", line ~56)
...
## excerpt
source: <vault>/10_projects/minelit/flf/2026-07-12-flf-cold-start-test-PROMPT.md (approx location: "What is TRUE and survives", line ~21)
...
## excerpt
source: <vault>/10_projects/minelit/flf/2026-07-12-flf-cold-start-test-PROMPT.md (approx location: "What is TRUE and survives", line ~20)
...
## excerpt
source: <vault>/10_projects/minelit/flf/2026-07-12-flf-cold-start-test-PROMPT.md (approx location: "PART B — THE COLD-START TEST / Why it matters", line ~58)
...
## excerpt
source: <vault>/10_projects/minelit/flf/2026-07-12-flf-claims-explained.md (approx location: Claim 5, scoping fact 1, line ~157)
...
## excerpt
source: <vault>/10_projects/minelit/flf/2026-07-11-flf-operating-requirement-and-estimand-scope-session.md (approx location: §3 "FINDING B", line ~80)
...
## excerpt
source: <vault>/10_projects/minelit/judge-dependence/digests/2026-07-15-decision-transplant-digest.md (approx location: §0 "Design freeze / Frozen directional readings", line ~19)
...
## excerpt
source: <vault>/10_projects/minelit/judge-dependence/digests/2026-07-15-decision-transplant-digest.md (approx location: §4 "Three-way mechanistic verdict", line ~104)
...
## excerpt
source: <vault>/10_projects/minelit/judge-dependence/digests/2026-07-15-decision-transplant-digest.md (approx location: §4 "Leading remaining hypothesis", line ~105)
...
## excerpt
source: <vault>/10_projects/minelit/judge-dependence/digests/2026-07-15-decision-transplant-digest.md (approx location: §3 "D3 mechanical-from-own-confidences", reading 3, line ~85)
...
## excerpt
source: <vault>/10_projects/minelit/judge-dependence/digests/2026-07-15-decision-transplant-digest.md (approx location: §5 "What this does to the practical recipe", line ~109)
...
## excerpt
source: <vault>/10_projects/minelit/judge-dependence/digests/2026-07-15-enumeration-layer-digest.md (approx location: §0 "Frozen definitions", line ~17)
...
## excerpt
source: <vault>/10_projects/minelit/judge-dependence/digests/2026-07-15-enumeration-layer-digest.md (approx location: §4 "Mechanical selector prototypes", line ~141)
...
## excerpt
source: <vault>/10_projects/minelit/judge-dependence/digests/2026-07-15-enumeration-layer-digest.md (approx location: §5 "Verdict", line ~145)
...
## excerpt
source: <vault>/10_projects/minelit/judge-dependence/digests/2026-07-15-enumeration-layer-digest.md (approx location: §9 "For the orchestrator", item 2, line ~189)
...
## excerpt
source: <vault>/10_projects/minelit/judge-dependence/digests/2026-07-15-set-arm-digest.md (approx location: §0 "Design freeze / S-arm contract", line ~17)
...
## excerpt
source: <vault>/10_projects/minelit/judge-dependence/2026-07-15-examples-anthology.md (approx location: line 440, item note)
...
## excerpt
source: <vault>/10_projects/minelit/judge-dependence/digests/2026-07-15-cq4-blindspot-enumeration-digest.md (approx location: §0 "Design freeze / Arms", line ~16)
...
- **C1 (m*): GOOD.** Appears under the aliases `m*`, "critical `m`", and "extremization multiplier / extremization coefficient". Well described in the project's own idiolect (the closed form `m* = need / D̄`, "volume knob," "need/have ratio," per-question verdict-flip). BUT the concept is also framed in borrowed statistical vocabulary throughout the source: verbatim terms attached — "log-odds", "logit", "prior", "posterior log-odds", "extremization multiplier"/"extremization coefficient", "confidence interval", "standard error", "`D ∝ 1/SE²`", "Brier", "effective count"/"n_eff", "variance-equivalent sample size". (Passages tying `m*`/count to a named author's `n_eff` and to a named overlap metric were SKIPPED per the citation rule.)

- **C2 (operating requirement): GOOD.** Appears as "operating requirement", "cold-start operating requirement", "the question nobody had asked (how good must a dependence estimate be before it beats not having one)", and the "operating requirement is known" bar. Described largely in project idiolect (the RMSE-to-prize-retained curve; "worse than no estimator"; "borrowed or assumed constant"; simulated-error framing). Borrowed statistical vocabulary attached — verbatim: "log-count RMSE", "Brier", "ECE", "confidence intervals / 90% CIs", "cross-validate / CV", "shuffled-count control", "lognormal", "bias", "σ", "tuned global constant". The threshold itself (RMSE ≲ 0.3 / ~0.6 / ~1.0) is stated in the borrowed RMSE metric.

- **C3 (signal-not-cut): GOOD.** The exact phrase "the signal, not the cut, is the bottleneck" does NOT appear verbatim in the allowed files; the concept appears in project idiolect as the "gate-policy bottleneck" test (which does not fire), "re-thresholding recovers nothing / no fixed τ transfers", and "the loss lives/sits in the CREDENCE LEVEL — the p mass assigned to second readings" (vs the gate/cut). "Generation stays rich while the gate stays strict" is the sharpest idiolect statement. Borrowed statistical vocabulary attached — verbatim: "threshold", "τ / τ̂", "operating point", "hedge-recall", "false-hedge", "J", "Brier", "AUROC", "credence(s)", "argmax", "TE (threshold-explainability)", "AC (argmax-consistency)", "in-sample", "out-of-sample". (One passage in _archive/2026-07-13-session-findings.md stating "the bottleneck is the inputs, not the algorithm" was SKIPPED — it carried named-author citations.)

- **C4 (read-the-enumerations): GOOD.** Appears as "enumeration layer", "the enumeration IS the answer", "read the sets / emitted sets", "S-arm (set-valued output contract)", "enumerate-then-select", and "the gate, not the recognizer, was the bottleneck". Strongly in project idiolect (emitted set S, coverage/overshoot of the set, "the correlated error sits in what the models offer up for consideration, not how the commit policy gates it", "the commit stage is where the panel's information dies"). Borrowed statistical vocabulary attached — verbatim: "φ / Pearson on binary error vectors", "coverage", "exact", "overshoot", "oracle / oracle-selector", "response rate", "majority vote", "Wilson CIs", "bootstrap", "AUROC", "J". (Passages naming an author's correlation statistic and a named-paradox decomposition framing, plus external dataset IDs, were SKIPPED per the citation rule.)
